...
test_font = pygame.font.Font('pygame_/Pixeltype.ttf', 50) 
game_active = True

sky_surface = pygame.image.load('pygame_/sky.png').convert() 
ground_surface = pygame.image.load('pygame_/ground.png').convert()
...
snail_surface = pygame.image.load('pygame_/snail1.png').convert_alpha()
fly_surf = pygame.image.load('pygame_/fly1.png').convert_alpha()

player_walk_1 = pygame.image.load('pygame_/player_walk_1.png').convert_alpha()
player_walk_2 = pygame.image.load('pygame_/player_walk_2.png').convert_alpha()
...
player_stand = pygame.image.load('pygame_/player_stand.png').convert_alpha()
