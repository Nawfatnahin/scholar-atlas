  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-stone-50 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] bg-white border border-stone-200 shadow-xl p-8 rounded-[24px] relative z-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <h1 className="text-[28px] font-bold text-stone-900 tracking-tight mb-2">Welcome back</h1>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4 text-left">
          <div>
            ...
            <input
              ...
              className="w-full text-[14px] px-4 py-3 rounded-xl border border-stone-200 bg-white outline-none transition-colors focus:border-amber-500 focus:ring-2 focus:ring-amber-500/10"
              placeholder="you@example.com"
            />
          </div>
          <div>
            <div className="flex justify-between items-center mb-1.5 ml-1">
              <label className="block text-[13px] font-bold text-stone-700">Password</label>
              <Link href="/login/forgot-password" hidden className="text-[12px] font-semibold text-amber-600 hover:underline">
                Forgot password?
              </Link>
            </div>
            <input
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full text-[15px] font-semibold text-white bg-stone-900 rounded-xl px-4 py-3.5 mt-2 transition-all hover:bg-stone-800 disabled:bg-stone-400 active:scale-[0.98]"
          >
